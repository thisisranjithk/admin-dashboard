  ...
  return (
    <div className="db-content-container">
      <div className="db-content-row-1">
        <div className="content-large-data-box content-welcome">
          <Welcome />
        </div>
        <div className="content-medium-data-box content-bar-chart">
          <Barchart />
        </div>
      </div>
      <div className="db-content-row-2">
        <div className="line-graph-1 graph-width">
          <Linechart />
        </div>
        <div className="line-graph-2 graph-width">
          <Linechart />
        </div>
        <div className="line-graph-3 graph-width">
          <Linechart />
        </div>
      </div>
